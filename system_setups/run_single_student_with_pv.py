...
class HouseholdAdvancedHpEvPvBatteryConfig(SystemSetupConfigBase):
    ...
    def get_default(cls):
        ...
        pv_config = generic_pv_system.PVSystemConfig.get_balcony_pv_system()
        ...
        household_config = HouseholdAdvancedHpEvPvBatteryConfig(
            ...
            occupancy_config=loadprofilegenerator_utsp_connector.UtspLpgConnectorConfig(
                ...
                household=Households.CHR12_Student_2_Male_Philosophy,
                energy_intensity=EnergyIntensityType.EnergySaving,
                result_dir_path=utils.HISIMPATH["utsp_results"],
                travel_route_set=TravelRouteSets.Travel_Route_Set_for_05km_Commuting_Distance,
            ...
            car_config=generic_car.CarConfig.get_default_eroller_config(),
            car_battery_config=advanced_ev_battery_bslib.CarBatteryConfig.get_eroller_config(),
